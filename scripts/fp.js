...
let faveMovies = ["Auntie Mame", "Splash", "Selena", "Clueless"]
...
addMovie("Wet Hot American Summer")
...
const classicMoviePicker = () => {
  for (let i=0; i < faveMovies.length; i++) {
    if (faveMovies[i] === "Auntie Mame") {
      console.log("This is a classic movie.")
    } else {
      console.log("This is a modern movie.")
    }
  }
}
...
// const stringOne = "Happy "
// const stringTwo = "Birthday "
// const stringThree = "to you!"

const sentenceMaker = (stringOne, stringTwo, stringThree) => {
  const sentence = stringOne + stringTwo + stringThree
  return sentence
}

//Invoke the function and console log the output
console.log(sentenceMaker("Happy ", "Birthday ", "to you!"));

// // Create a function that console logs the multiplicative of 2 numbers
const mathTime = (num1, num2) => {
